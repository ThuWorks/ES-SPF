merge_redlist <- function(sp_df, column) {
  # Might want to make the selection into its own atom or in the setup
  
  cc$aquamarine("Merging redlist with species.")
  
  redlist_pre <- fread("./resources/synonym_checked/sp/redlist/wfo_one_checklist.csv")
